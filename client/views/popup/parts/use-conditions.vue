...
.use-conditions
	...
	.content
		...
		ul
			...
			li 
				| Некоторые услуги сервиса Directbot предоставляются 
				| бесплатно до #[br.no-desk]определенного объема.

			li 
				| Условия предоставления платных услуг#[br.no-desk] указаны
				| в договоре публичной аферты,#[br.no-desk]
				| доступном после регистрации
				| при#[br.no-desk] выборе тарифного плана.


			li
				| Мы оставляем за собой право #[br.mobile]
				| использовать результат совместной #[br.mobile]
				| работы с нашими клиентами #[br.mobile]
				| для саморекламы, а также #[br.mobile]
				| изменять наш сервис.
			li
