...
.who-need(
  ...
  .wrap-boxes
    .wrap-box
      ...
      .paragraph
        p кто продаёт в Instagram,#[br] но не успевает отвечать#[br] в Direct и на комментарии
    ...
    .wrap-box
      ...
      .paragraph
        p кому нужно больше продаж,#[br]интернет-магазин и #[br] реклама у блогеров
