  ...
  data () {
    ...
    return {
      ...
      articles:[
        ...
        {
          img: require("./images/review_babyliss_club.png"),
          shop: "babyliss_club",
          category: "Профессиональные приборы",
          text: `
            "Очень довольны результатом. Команда Directbot подобрала нам более 50 блогеров, из которых мы отобрали половину и сделали у них мультиформатное размещение. По сравнению с проведением конкурса в прошлом году, охват был гораздо больше. Финалистки узнавали о конкурсе в основном из инстаграма."
          `,
          author: "Виктория,<br> организатор мероприятия"
        },
        {
          img: require("./images/review_buro925.png"),
          shop: "buro925",
          category: "Магазин украшений из стекла",
          text: `
              "Меня предупреждали, что получить сразу продажи от блогера новому магазину бывает непросто. Но мне повезло! С самого первого блогера получила 6 продаж. А может быть это благодаря каскадному размещению контента... Спасибо за совет и что берете на себя всю рутину!"
          `,
          author: "Анастасия,<br> основатель бренда"
        }
      ]
    };
  }
